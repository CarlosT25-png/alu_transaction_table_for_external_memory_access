...
REM
REM Generated by Vivado on Tue Nov 11 12:06:48 -0600 2025
...
echo "xvlog --incr --relax -L uvm -prj Transaction_Table_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Transaction_Table_tb_vlog.prj -log xvlog.log
